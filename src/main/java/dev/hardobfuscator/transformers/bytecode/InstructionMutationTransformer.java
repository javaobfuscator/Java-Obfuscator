...
/**
 * Replaces selected instructions with semantically equivalent alternatives.
 */
public final class InstructionMutationTransformer extends AbstractTransformer {

    @Override
    public String name() {
        return "instructionMutation";
    }

    @Override
    public String description() {
        return "Replaces instructions with semantically equivalent alternatives";
    }
